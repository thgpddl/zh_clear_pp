...
class FerNet_GAP(nn.Layer):
    def __init__(self):
        super(FerNet_GAP, self).__init__()
...
# tensor=paddle.to_tensor([[[[1,2],[3,4]],[[4,5],[6,7]]]],dtype=paddle.float32)  #1,2,2,2
# op=nn.AdaptiveAvgPool2D(output_size=(1, 1))
#
# print(op(tensor))
#
#
